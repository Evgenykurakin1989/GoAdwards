...
class UserManager(BaseUserManager):
    ...
    def alert_users_of_imminent_card_expiry(self, raise_for_errors=False, loghook=None):
        ...
        for user in qs:
            ...
            context = {
                'card_number_mask': (
                    user.initial_continuous_authority_payment.response.card_number_mask
                ),
            }
    ...
    def lock_out_users_with_expired_cards(self):
        ...
        for user in qs:
            user.previous_initial_continuous_authority_payments.add(
                user.initial_continuous_authority_payment)

            user.initial_continuous_authority_payment = None
